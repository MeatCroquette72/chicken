...
config = {
    ...
    "friends": "u",
    "invisible": True,
    "healthPotAtPercent": 0.70,  # health threshold to trigger potion
    ...
    "auraRepair": False,  # True if you have aura, if not then for non-aura users: MUST have your character parked near a repairer in city before starting the script
    ...
    "charSelectConnectY": 700,
    "charSelectOkX": 920,
    "charSelectOkY": 590,
    "SwitchCharactersX": 540,
    "SwitchCharactersY": 682,
    # Scroll Up
    "CharacterScrollUpX": 1269,
    "CharacterScrollUpY": 426,
    # Scroll Down
    "CharacterScrollDownX": 1266,
    "CharacterScrollDownY": 638,
    # Switch Characters Connect
    "CharacterConnectX": 1022,
    "CharacterConnectY": 700,
